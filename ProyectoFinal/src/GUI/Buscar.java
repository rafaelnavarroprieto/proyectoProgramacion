...
public class Buscar extends javax.swing.JDialog {
    ...
    public Buscar(JFrame principal) {
        super();
        initComponents();
        setTitle(Intermediaria.archivo.getName() + " - Almacen de unidades - " + Intermediaria.getFecha());
        //botones limpiar
    ...
    private void initComponents() {
        ...
        getContentPane().add(listaCompleta, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 630, 230));
    ...
    private void probarUnidadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_probarUnidadActionPerformed
        try {
            test = new Testeo(Intermediaria.lista.getUnidad(nombre.getText()), this);
    ...
    private void probarUnidad1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_probarUnidad1ActionPerformed
        try {
            test = new Testeo(Intermediaria.lista.getUnidad(nombre1.getText()), this);
            test.setVisible(true);
            setVisible(false);
        } catch (UnidadNoExistenteException ex) {
    ...
    private void probarUnidad2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_probarUnidad2ActionPerformed
        try {
            test = new Testeo(Intermediaria.lista.getUnidad(nombre2.getText()), this);
            test.setVisible(true);
            setVisible(false);
        } catch (UnidadNoExistenteException ex) {
            JOptionPane.showMessageDialog(contentPanel, ex.getMessage(), "ERROR!!!!", JOptionPane.ERROR_MESSAGE);
     ...
     *
     * @param indiceTotal posición de la unidad
     */
    private void mostrarUnidad(int indiceTotal) {
        try {
            nombre.setText(Intermediaria.lista.getUnidadIndice(indiceTotal).getNombre());
            if (Intermediaria.lista.getUnidadIndice(indiceTotal) instanceof Protos) {//Comprobamos si es protos por el escudo
                Protos p = (Protos) Intermediaria.lista.getUnidadIndice(indiceTotal);
            ...
            ataque.setText(Float.toString(Intermediaria.lista.getUnidadIndice(indiceTotal).getAtaque()));
            fecha.setText(Intermediaria.lista.getUnidadIndice(indiceTotal).getFechaDeCreacion());
     ...
     *
     * @param indiceRaza indice de la unidad
     */
    private void mostrarRaza(int indiceRaza) {
        try {
            ...
            if (copia.get(indiceRaza) instanceof Protos) { // Comprobamos si es protos para el campo escudo
            ...
            victorias1.setText(Integer.toString(copia.get(indiceRaza).getVictorias()));
            derrotas1.setText(Integer.toString(copia.get(indiceRaza).getDerrotas()));
            ...
            //Modificación de los botones y los radio de la raza al buscar una unidad
    ...
    private void mostrarTipo(int indiceTipo) {
        try {
            ...
            if (copia.get(indiceTipo) instanceof Protos) { //Se comprueba si es protos para el campo escudo
            ...
            //Datos básicos de la unidad
            victorias2.setText(Integer.toString(copia.get(indiceTipo).getVictorias()));
            derrotas2.setText(Integer.toString(copia.get(indiceTipo).getDerrotas()));
            ...
            //Modificación de los botones y los radio del tipo al buscar una unidad
